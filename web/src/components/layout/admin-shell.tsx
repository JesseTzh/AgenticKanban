...
export function AdminShell({ children, title }: AdminShellProps) {
  ...
  return (
    <div className="min-h-screen bg-background" data-testid="admin-shell">
      <header
        className="sticky top-0 z-40 flex h-16 items-center justify-between bg-glass px-4 shadow-[0_8px_24px_rgb(0_30_45/0.05)] backdrop-blur-[20px] dark:shadow-[0_8px_24px_rgb(0_212_236/0.04)] md:px-8"
      ...
      <main
        aria-label={title}
        className="admin-main relative min-h-[calc(100vh-4rem)] overflow-hidden px-4 py-8 md:px-8 md:py-12"
