...
export type Task = { ID:string; ProjectID:string; ParentID:string; Title:string; Description:string; StageKey:string; Status:string; AgentReady:boolean; Locked:boolean; AgentID:string }
...
export type Archive = { ID:string; TaskID:string; Version:number; Content:string; CreatedBy:string; CreatedAt:string }
