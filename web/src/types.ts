...
export type Task = { ID:string; ProjectID:string; ParentID:string; Title:string; Description:string; Detail:string; StageKey:string; Status:string; AgentReady:boolean; Completed:boolean; AgentID:string }
