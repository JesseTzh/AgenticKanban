  ...
  return (
    <AdminShell projectID={projectID} title="任务看板">
      <div className="mb-6 flex items-center justify-between" data-test-id="board-heading">
        <div data-test-id="board-heading-copy"><h2 className="text-2xl font-semibold" data-test-id="board-title">任务工作流</h2><p className="text-sm text-muted-foreground" data-test-id="board-description">沿四个阶段推进任务并记录审核、测试和完成结果。</p></div>
      ...
      <div className="overflow-x-auto pb-4" data-test-id="board-columns">
        <div className="grid min-w-max grid-cols-4 gap-4" data-test-id="board-columns-grid">
          {columns.map((stage) => (
